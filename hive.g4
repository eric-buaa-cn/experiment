...
create_table_hive_partitioned :
        T_PARTITIONED T_BY T_OPEN_P create_table_hive_partitioned_columns T_CLOSE_P
     ;

create_table_hive_partitioned_columns :
        create_table_hive_partitioned_columns_item (T_COMMA create_table_hive_partitioned_columns_item)*
     ;

create_table_hive_partitioned_columns_item :
        column_name dtype
     ;
...
insert_stmt :           // INSERT statement
       cte_select_stmt? T_INSERT (T_OVERWRITE T_TABLE | T_INTO T_TABLE?) table_name insert_stmt_cols? insert_stmt_options? (select_stmt | insert_stmt_rows)
     ;
...
insert_stmt_options :
        T_PARTITION T_OPEN_P insert_stmt_column_assign (T_COMMA insert_stmt_column_assign)* T_CLOSE_P
     ;

insert_stmt_column_assign :
        column_name (T_EQUAL expr)?
     ;
